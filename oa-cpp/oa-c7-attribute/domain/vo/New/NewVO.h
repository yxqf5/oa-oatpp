...
{
    DTO_INIT(NewVO, DTO);
    API_DTO_FIELD_DEFAULT(String, logo, ZH_WORDS_GETTER("newdto.get.logo"));
    ...
    API_DTO_FIELD_DEFAULT(String,ds , ZH_WORDS_GETTER("newdto.get.ds"));
    API_DTO_FIELD_DEFAULT(String, sort, ZH_WORDS_GETTER("newdto.get.sort1"));
    //API_DTO_FIELD_DEFAULT(String, type, ZH_WORDS_GETTER("newdto.get.type"));
    API_DTO_FIELD_DEFAULT(String, document, ZH_WORDS_GETTER("newdto.get.document"));
    //API_DTO_FIELD_DEFAULT(String, type, ZH_WORDS_GETTER("newdto.get.type"));
    ...
    API_DTO_FIELD_DEFAULT(String, edit, ZH_WORDS_GETTER("newdto.get.edit"));
    API_DTO_FIELD_DEFAULT(String, save, ZH_WORDS_GETTER("newdto.get.save"));
