...
class DeleteAttachVO: public oatpp::DTO
{
	DTO_INIT(DeleteAttachVO, DTO);
 ...
 */
class DeleteAttachJsonVO: public JsonVO<DeleteAttachVO::Wrapper> {
	DTO_INIT(DeleteAttachJsonVO, JsonVO<DeleteAttachVO::Wrapper>);
};
